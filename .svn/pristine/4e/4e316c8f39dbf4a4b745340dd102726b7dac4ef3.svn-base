...
<SCRIPT LANGUAGE="JavaScript">
	...
	function validateChild(num1) {
		if (num1.value.length == 0 || !isInteger(num1.value)) {
	...
	function validateSubmit(form) {
		...
		if ((!validateChild(document.cso.input15))
				|| (!validateChild(document.cso.input17))
				|| (!validateChild(document.cso.input18))
				|| (!validateInt(document.cso.input7))
				|| (!validateInt(document.cso.input8))
				...
				|| (!validate(document.cso.input13))
				|| (!validate(document.cso.input14)))
		{
			return false;
	...
	<div class="gutter">
		...
		<FORM name="cso" method="post" action="workSheetBCalc.htm">
			...
			<table style="border-collapse: collapse" width="100%" border="0"
				...
				<tr>
					<td style="padding-top: 1px" style=padding-bottom:1px width="50%">Number of
							children</td>
					<td style="padding-top: 1px" style=padding-bottom:1px width="25%">
						<input type=text name="input15" value="1" size="2" maxlength="2">
				...
				<tr>
					<td style="padding-top: 1px" style=padding-bottom:1px width="50%">Monthly Gross
							Income</td>
					<td style="padding-top: 1px" style=padding-bottom:1px width="25%"><input
						type=text name=input1 value="0.00" size="13" maxlength="13"></td>
						 
					<td style="padding-top: 1px" style=padding-bottom:1px width="25%"><input
						type=text name=input2 value="0.00"  size="13" maxlength="13"></td>
				...
				<tr>
					...
					<td style="padding-top: 1px" style=padding-bottom:1px width="25%"><input
						type=text name="input3" value="0.00"  size="13" maxlength="13"></td>
						
					<td style="padding-top: 1px" style=padding-bottom:1px width="25%"><input
						type=text name="input4" value="0.00" size="13" maxlength="13"></td>
				...
				<tr>
					...
					<td style="padding-top: 1px" style=padding-bottom:1px width="20%"><input
						type=text name=input17 value="0" size="2" maxlength="2"></td>
						 
					<td style="padding-top: 1px" style=padding-bottom:1px width="20%"><input
						type=text name=input18 value="0" size="2" maxlength="2"></td>
				...
				<tr>
					<td style="padding-top: 1px" style=padding-bottom:1px width="50%">OVERNIGHTS
							with each parent</td>
					<td style="padding-top: 1px" style=padding-bottom:1px width="25%"><input
						type=text name=input7 value="0" size="13" maxlength="13"></td>
						 
					<td style="padding-top: 1px" style=padding-bottom:1px width="25%"><input
						type=text name=input8 value="0" size="13" maxlength="13"></td>
				...
				<tr>
					...
					<td style="padding-top: 1px" style=padding-bottom:1px width="25%"><input
						type=text name=input9 value="0.00"  size="13" maxlength="13"></td>
						
					<td style="padding-top: 1px" style=padding-bottom:1px width="25%"><input
						type=text name=input10 value="0.00"  size="13" maxlength="13"></td>
				...
				<tr>
					<td style="padding-top: 1px" style=padding-bottom:1px width="50%">Health
							Insurance Premium costs</td>
					<td style="padding-top: 1px" style=padding-bottom:1px width="25%"><input
						type=text name=input11 value="0.00"  size="13" maxlength="13"></td>
						
					<td style="padding-top: 1px" style=padding-bottom:1px width="25%"><input
						type=text name=input12 value="0.00"  size="13" maxlength="13"></td>
				...
				<tr>
					<td style="padding-top: 1px" style=padding-bottom:1px width="50%">Extraordinary
							expense</td>
					<td style="padding-top: 1px" style=padding-bottom:1px width="25%"><input
						type=text name=input13 value="0.00"  size="13" maxlength="13"></td>
						
					<td style="padding-top: 1px" style=padding-bottom:1px width="25%"><input
						type=text name=input14 value="0.00"  size="13" maxlength="13"></td>
