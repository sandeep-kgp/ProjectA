	...
	<form name="form1" method="post" action="GuideLinesTable.jsp">
		...
		<table width="39%">
			<tr>
				...
				<td width="94%" height="21"><font size="2">Back to Child
		...
		<table width="100%" border="1" cellpadding="0" cellspacing="0"
			...
			<tr>
				<td height="84" colspan="7">
					<div align="center">
						<p>
							<font><b><font size="5" color="#0000FF"><a NAME="MBCSO"></a>North
										Carolina</font></b></font>
						</p>
						<p>
							<font color="#0000FF"><b><font size="2">Proposed
			...
			<tr>
				<td width="10%" rowspan="2"><b>
				<font color="#0000FF" size="2">Combined	Adjusted Gross Income</font></b></td>
				<td colspan="6">
					<div align="center">
			...
			<tr>
				<td width="15%"><b><font color="#0000FF" size="2">One Child</font></b></td>
				<td width="15%"><b><font color="#0000FF" size="2">Two Children</font></b></td>
				<td width="15%"><b><font color="#0000FF" size="2">Three Children</font></b></td>
				<td width="15%"><b><font color="#0000FF" size="2">Four Children</font></b></td>
				<td width="15%"><b><font color="#0000FF" size="2">Five Children</font></b></td>
				<td width="15%"><b><font color="#0000FF" size="2">Six Children</font></b></td>
			</tr>
				...
				<tr>
					...
					<c:choose>
						<c:when
							...
							<td bgcolor="#CCCCCC" width="15%" height="10"><font size="2">${guideLine.getGdlnAmtChild4()}</font></td>
		...
		<table width="427">
			<tr>
				<td width="29%" height="21"><font size="2">AOC-A-162, Rev.
						1/15 </font></td>
			</tr>
			<tr>
				<td width="29%" height="19"><font size="2">&copy; 2015
