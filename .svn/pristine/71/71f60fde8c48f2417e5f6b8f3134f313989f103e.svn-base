...
public class CaseParticipantServiceImpl implements CaseParticipantService
{
	...
	public String CreateCaseParticipantCP(CaseParticipant partInfo, ParamData pageData, String ncId) throws SQLException
	{
		...
		if (partId == null || partId.trim().equals("")) { throw new RuntimeException("CreateCaseParticipantCP: CP Applicant Id is empty."); }
	...
	@Transactional
	public String CreateCaseParticipantNCP(CaseParticipant partInfo, ParamData pageData, String ncId)
			throws SQLException
	{
	...
	@Transactional
	public String CreateCaseParticipantChld(CaseParticipant partInfo, ParamData pageData, String ncId)
			throws SQLException
	{
	...
	public String CreateApplicant(CaseApplication applBean, CaseParticipant partInfo, String ncId,
			Map<String, CasePartBenefit> benefitsMap, ThirdParty thirdPartyBean) throws SQLException
	{
	...
	private String processPartAddress(CasePartAddress addrBean, String ncId, String opType) throws SQLException
	{
		...
		{
			if (returnCode != null && !returnCode.equals("") && !returnCode.substring(0, 4).trim().equals(AppConstants.OPERATION_SUCCESS)) { throw new RuntimeException("processUpdatePartAddress: Save/Update failed. Return code: " + returnCode); }
		}
	...
	@Transactional
	private String processPartAddressData(String applicationId, String applicantId, List<CasePartAddress> addrList,
			String ncId, String opType, String role) throws SQLException
	{
		String returnCode = AppConstants.OPERATION_SUCCESS;
	 ...
	 */
	@Transactional
	private String processPartContactData(String applicationId, String applicantId, List<CasePartContact> contactList,
			String ncId, String opType, String role) throws SQLException
	{
		String returnCode = AppConstants.OPERATION_SUCCESS;
	...
	@Transactional
	private String updateThirdParty(ThirdParty thirdPartyBean, String applicationId, String ThirdPartyType, String ncId)
			throws SQLException
	 ...
	 */
	@Transactional
	private String processPartIncome(String applicationId, String applicantId, Map<String, String> incList, String ncId,
			String opType) throws SQLException
	{
		String returnCode = AppConstants.OPERATION_SUCCESS;
	 ...
	 */
	@Transactional
	private String processPartBenefit(String applicationId, String applicantId,
			Map<String, CasePartBenefit> benefitList, String partType, String ncId, String opType) throws SQLException
	{
		String returnCode = AppConstants.OPERATION_SUCCESS;
		boolean dbUpdate = false;
	 ...
	 * @throws SQLException
	 */
	public List<CasePartBenefit> getParticipantBenefit(String applId, String applicantId, String partType)
			throws SQLException
	{
		return benefitDao.getCasePartBenefitsByFieldId(applId, applicantId, partType);
	}
	...
	@Transactional
	private String processPartExtDetails(CasePartNCPExt ncpExtDetails, String partId, String ncId, String opType)
			throws SQLException
	{
	...
	@Transactional
	private String processPartRelNamesInfo(Map<String, CasePartOther> selectRelNameMap, String applId, String partId,
			String ncId, String opType) throws SQLException
	...
	@Transactional
	private String processPartVehicleInfo(List<Vehicle> vehicleList, String applId, String partId, String ncId,
			String opType) throws SQLException
	{
	...
	@Transactional
	private String processCourtOrderInfo(Map<String, CaseCourtOrder> selectedOrderMap,
			Map<String, String[]> childrenMap, String applicationId, String applicantId, String ncId, String opType)
			throws SQLException
	{
		...
		else
		{
			if (opType.equals(AppConstants.OPERATION_UPDATE))
			{
				...
				for (CaseCourtOrder updatedOrderBean : updatedOrderList)
				{
					...
					/*
					 * case 3: String[] spousalChildren = childrenMap.get("3");
					 ...
					 * returnCode =
					 * caseOrderChildDao.createCasePartOrder(insertChildBean,
					 * ncId); if (returnCode == null || !returnCode.substring(0,
					 * 4).trim().equals(AppConstants.OPERATION_SUCCESS)) throw
					 * new
					 * RuntimeException("processCourtOrderInfo: create failed, Rollback this transaction!"
					 * ); } break;
					 */
	...
	@Transactional
	private String processPartChldAffil(String applicationId, String childId, Map<String, String> ncpChldList,
			List<CasePartChldAffil> ncpToAdd, String ncId, String opType) throws SQLException
	{
		String returnCode = AppConstants.OPERATION_SUCCESS;
		boolean dbUpdate = false;
	 ...
	 */
	@Transactional
	private String processPartEmp(String applicationId, String applicantId, CasePartEmp empBean, String ncId,
			String opType) throws SQLException
	{
		String returnCode = AppConstants.OPERATION_SUCCESS;
	...
	@Transactional
	private String processPartInsurance(String applicationId, String applicantId,
			Map<String, CasePartInsurance> insuranceList, String ncId, String opType) throws SQLException
	{
		String returnCode = AppConstants.OPERATION_SUCCESS;
		boolean dbUpdate = false;
	...
	@Transactional
	private String processPartProfile(String applicationId, String applicantId, CasePartProfile partProfile,
			String ncId, String opType) throws SQLException
	{
		String returnCode = AppConstants.OPERATION_SUCCESS;
	...
	@Transactional
	private String processPartOther(String applicationId, String applicantId, Map<String, CasePartOther> partOtherList,
			String ncId, String opType) throws SQLException
	{
		String returnCode = AppConstants.OPERATION_SUCCESS;
		boolean dbUpdate = false;
	 ...
	 */
	@Transactional
	private String processPartPaternty(String applicationId, String chldId, CasePartPaternty paterntyBean, String ncId,
			String opType) throws SQLException
	{
		String returnCode = AppConstants.OPERATION_SUCCESS;
		boolean dbUpdate = false;
	...
	@Transactional
	private String processPartProfileExt(String applicationId, String applicantId,
			Map<String, CasePartProfileExt> partProfileExtList, String ncId, String opType) throws SQLException
	{
		String returnCode = AppConstants.OPERATION_SUCCESS;
		boolean dbUpdate = false;
