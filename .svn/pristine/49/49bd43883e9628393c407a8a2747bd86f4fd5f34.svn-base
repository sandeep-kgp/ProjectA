...
<div id="content">
	<div class="gutter">
		...
		<p>Please enter NCID username and password below to login. </p>	
		...
		<c:choose>
            <c:when test="${fn:containsIgnoreCase(deployedEnv, 'DEV')}">
		       <p align="center">Forgot username/password? Visit <a target="_blank" href=https://idpdev.nc.gov:8443/nidp/idff/sso?/>DEV NCID</a> to reset your username/password and return to this page to login.</p>
	        </c:when>
	        <c:when test="${fn:containsIgnoreCase(deployedEnv, 'PREPROD')}">
		       <p align="center">Forgot username/password? Visit <a target="_blank" href=https://idppre.nc.gov:8443/nidp/idff/sso?/>PRE-PROD NCID</a> to reset your username/password and return to this page to login.</p>
	        </c:when>	       
          	<c:otherwise>
		      <p align="center">Forgot username/password? Visit <a target="_blank" href=https://ncid.nc.gov />NCID</a> to reset your username/password and return to this page to login.</p>
		  	</c:otherwise>	      
        </c:choose>
