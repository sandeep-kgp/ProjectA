		...
		try {
				...
				if (plaintiffTotalInc == 0.00) {
					...
					if (plaintiffTotalInc <= 1050.00) {
						...
						if (childE == 'Y') {
							...
							plaintiffRespOthrChildren = ((((plaintiffTotalInc - gdlnIncomeLess)
									/ (gdlnIncomeGtr - gdlnIncomeLess)) * (childGtr - childLess)) + childLess);
						}
					}
				}
				...
				if (defendantTotalInc == 0.00) {
					...
					if (defendantTotalInc <= 1050.00) {
						...
						if (childE == 'Y') {
							...
							defendantRespOthrChildren = ((((defendantTotalInc - gdlnIncomeLess)
									/ (gdlnIncomeGtr - gdlnIncomeLess)) * (childGtr - childLess)) + childLess);
						}
					}
				}
			...
			if (combinedAdjGrossInc <= 1150.00) {
				...
				if (childE == 'Y') {
					...
					basicObligation = (((combinedAdjGrossInc - gdlnIncomeLess) / (gdlnIncomeGtr - gdlnIncomeLess))
							* (childGtr - childLess)) + childLess;
				}
			}
			...
			switch (totalChildren) {
			case 1:
				if (plaintiffGrossInc < 1850.00)
					ChildCarePL = 1.00;
				break;
			case 2:
				if (plaintiffGrossInc < 2500.00)
					ChildCarePL = 1.00;
				break;
			case 3:
				if (plaintiffGrossInc < 2800.00)
					ChildCarePL = 1.00;
				break;
			case 4:
				if (plaintiffGrossInc < 3100.00)
					ChildCarePL = 1.00;
				break;
			case 5:
				if (plaintiffGrossInc < 3400.00)
					ChildCarePL = 1.00;
				break;
			case 6:
				if (plaintiffGrossInc < 3700.00)
					ChildCarePL = 1.00;
				break;
			}
			...
			switch (totalChildren) {
			case 1:
				if (defendantGrossInc < 1850.00)
					ChildCareDF = 1.00;
				break;
			case 2:
				if (defendantGrossInc < 2500.00)
					ChildCareDF = 1.00;
				break;
			case 3:
				if (defendantGrossInc < 2800.00)
					ChildCareDF = 1.00;
				break;
			case 4:
				if (defendantGrossInc < 3100.00)
					ChildCareDF = 1.00;
				break;
			case 5:
				if (defendantGrossInc < 3400.00)
					ChildCareDF = 1.00;
				break;
			case 6:
				if (defendantGrossInc < 3700.00)
					ChildCareDF = 1.00;
				break;
			}
