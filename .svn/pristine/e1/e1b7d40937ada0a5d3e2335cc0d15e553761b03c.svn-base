...
public class EcoaUserDetails implements UserDetails
{
	...
	private EcoaUser								ncIdUser			= null;
	...
	public EcoaUserDetails(String userId, String password, Collection<? extends GrantedAuthority> authorities,
			...
			String ipaddress, String browserAgent, PreNcIdUser preNCIdUser, EcoaUser ncIdUser, String errorMsg)
	{
		super();
	 ...
	 *            the ncIdUser to set
	 */
	public void setNcIdUser(EcoaUser ncIdUser)
	{
		this.ncIdUser = ncIdUser;
	}
