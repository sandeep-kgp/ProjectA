...
<body>
	<div id="wrap">
		...
		<div>
			<ul class="header2"> <h3 align="center">North Carolina Child Support Services</h3> </ul>
		</div>
		<div>
			<ul class="nav">
		...
		<div id="content">
			<div class="gutter">
				<h2>Welcome Parents/Guardians</h2>								               		 
	           	...
	           	<p>You can <strong><a href="loginp.htm?u=tcaId">Login</a></strong> now using your old username and password to get details about your North Carolina Child Support Services case. Your old username and password will expire after ten grace logins. 	</p>
			    ...
			    <c:choose>
			        ...
			        <c:when test="${fn:containsIgnoreCase(deployedEnv, 'PREPROD')}">
				      <p>Not registered for NCID yet? <strong><a target="_blank" href="https://idppre.nc.gov:8443/nidp/idff/sso?"> Register here (PRE-PROD NCID) </a></strong></p>
			        </c:when>	        
			        <c:otherwise>
