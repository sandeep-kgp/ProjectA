...
<script>
	...
	function validateform() {
		...
		if (document.OnlineAppNCPForm.email.value != ""
		 ...
		 if (document.OnlineAppNCPForm.specialAssistOt.value.trim() != "" && !alias_name_regex.test(document.OnlineAppNCPForm.specialAssistOt.value.trim())){
				alert("Special characters (except comma) and numbers are not allowed.");
				document.OnlineAppNCPForm.specialAssistOt.focus();
				return false;		
		  }
		...
		if (document.getElementById("weight").value.trim() != "" && !weight_regex.test(document.getElementById("weight").value)) {
			alert("Enter max three digit number for weight.");
			document.getElementById("weight").focus();
			return false;
		}
		
		
	  if (document.OnlineAppNCPForm.ma_city.value !="" && !name_regex.test(document.OnlineAppNCPForm.ma_city.value.trim())){
			alert("Special characters and numbers are not allowed for city.");
			document.OnlineAppNCPForm.ma_city.focus();
			return false;
		}
	  
	  if (!document.getElementById("res_addr").checked && document.OnlineAppNCPForm.res_city.value !="" && !name_regex.test(document.OnlineAppNCPForm.res_city.value.trim())){
			alert("Special characters and numbers are not allowed for city.");
			document.OnlineAppNCPForm.res_city.focus();
			return false;
		}
	  
	  if (document.OnlineAppNCPForm.other_city.value !="" && !name_regex.test(document.OnlineAppNCPForm.other_city.value.trim())){
			alert("Special characters and numbers are not allowed for city.");
			document.OnlineAppNCPForm.other_city.focus();
			return false;
		}
		...
		if (document.getElementById("ma_zip").value.trim() != ""
				&& !zip_regex.test(document.getElementById("ma_zip").value
						.trim())) {
			alert("Zip code should be all digits and 5 digits long.");
			document.getElementById("ma_zip").focus();
			return false;
		}
		if (!document.getElementById("res_addr").checked && document.getElementById("res_zip").value.trim() != ""
		...
		if (document.getElementById('emp_chk').value.trim() == "y" && (document.getElementById("emp_city").value.trim() != "" && !name_regex.test(document.getElementById("emp_city").value))) {
		alert("Special characters and numbers are not allowed for city.");
		document.getElementById("emp_city").focus();
		return false;
	    }
		...
		for (var m = 1, n = table.rows.length; m < n; m++) {
			...
			{
                alert("Vehicle year should not be greater than current year + 1.");
				...
				case '3':
					...
					if (document.OnlineAppNCPForm.sDt.value.trim() != ""
							&& (!(isValidDate(
									...
									"date of separation.")) || !(beforeFutureDate(
									document.OnlineAppNCPForm.sDt.value,
									"date of separation.")))) {
		...
		//// Aloa Id:7027 : 5-NCP page: Spousal Support-should not have to select child included in order
		...
		var courtPayorNm = document.OnlineAppNCPForm.court_payor.value.trim();
		
		if (document.getElementById("court").checked && courtPayorNm != "" && !name_regex.test(courtPayorNm)) {
				
			alert("Special characters and numbers are not allowed in name.");
			document.OnlineAppNCPForm.court_payor.focus();
			return false;
		}
		
        var courtRecipNm = document.OnlineAppNCPForm.court_recip.value.trim();
		
		if (document.getElementById("court").checked && courtRecipNm != "" && !name_regex.test(courtRecipNm)) {
				
			alert("Special characters and numbers are not allowed in name.");
			document.OnlineAppNCPForm.court_recip.focus();
			return false;
		}
       ...
       var medicalPayorNm = document.OnlineAppNCPForm.medical_payor.value.trim();
		
		if (document.getElementById("medical").checked && medicalPayorNm != "" && !name_regex.test(medicalPayorNm)) {
				
			alert("Special characters and numbers are not allowed in name.");
			document.OnlineAppNCPForm.medical_payor.focus();
			return false;
		}
		
        var medicalRecipNm = document.OnlineAppNCPForm.medical_recip.value.trim();
		
		if (document.getElementById("medical").checked && medicalRecipNm != "" && !name_regex.test(medicalRecipNm)) {
				
			alert("Special characters and numbers are not allowed in name.");
			document.OnlineAppNCPForm.medical_recip.focus();
			return false;
		}
		...
		if (document.getElementById("spousal").checked
		 ...
		 var spousalPayorNm = document.OnlineAppNCPForm.spousal_payor.value.trim();
			
			if (document.getElementById("spousal").checked && spousalPayorNm != "" && !name_regex.test(spousalPayorNm)) {
					
				alert("Special characters and numbers are not allowed in name.");
				document.OnlineAppNCPForm.spousal_payor.focus();
				return false;
			}
			
	        var spousalRecipNm = document.OnlineAppNCPForm.spousal_recip.value.trim();
			
			if (document.getElementById("spousal").checked && spousalRecipNm != "" && !name_regex.test(spousalRecipNm)) {
					
				alert("Special characters and numbers are not allowed in name.");
				document.OnlineAppNCPForm.spousal_recip.focus();
				return false;
			}
		...
		if (document.getElementById("voluntary").checked
		 ...
		 var voluntaryPayorNm = document.OnlineAppNCPForm.voluntary_payor.value.trim();
			
			if (document.getElementById("voluntary").checked && voluntaryPayorNm != "" && !name_regex.test(voluntaryPayorNm)) {
					
				alert("Special characters and numbers are not allowed in name.");
				document.OnlineAppNCPForm.voluntary_payor.focus();
				return false;
			}
			
	        var voluntaryRecipNm = document.OnlineAppNCPForm.voluntary_recip.value.trim();
			
			if (document.getElementById("voluntary").checked && voluntaryRecipNm != "" && !name_regex.test(voluntaryRecipNm)) {
					
				alert("Special characters and numbers are not allowed in name.");
				document.OnlineAppNCPForm.voluntary_recip.focus();
				return false;
			}
...
<form name="OnlineAppNCPForm" id="OnlineAppNCPForm" method="post" action="${pageContext.request.contextPath}/cssp/user/caseApplicationNCPDetails.htm" modelAttribute="partInfo">
	...
	<div id="aplContent">
		<div class="gutter2">
				...
				<h3>SECTION 4- NONCUSTODIAL PARENT INFORMATION <b><span  style="float:right;"><font size="2">Reference Number:${selectedApp}</font></span></b></h3>
				<hr />
...
"
				...
				<table>
					<tr>
						...
						<td><label colspan="2">Social Security No: </label><input
							type="text" name="ssnNb" title ="Enter SSN in format XXXXXXXXX." value="${partInfo.getSsnNb()}" size="9"
							maxlength="9"></td>
					</tr>
					<tr>
						<td colspan="2">&nbsp;</td>
					...
					<tr>
						<td colspan="4">
							<fieldset>
								...
								<label>First: </label><input type="text" name="f_first" id="f_first" title="Enter first name of noncustodial parent's father."
									value="${ncpRelNameMap.containsKey('1')?  ncpRelNameMap['1'].getFirstNm():''}" 
									size="30" maxlength="15"> <label>Middle:</label><input type="text" name="f_middle" id="f_middle" title="Enter middle name of noncustodial parent's father." value="${ncpRelNameMap.containsKey('1')?  ncpRelNameMap['1'].getMiddleNm():''}" 
									size="30" maxlength="15"> <label>Last:</label><input type="text" name="f_last" id="f_last"	title="Enter last name of noncustodial parent's father." value="${ncpRelNameMap.containsKey('1')?  ncpRelNameMap['1'].getLastNm():''}"  size="30" maxlength="17">
							</fieldset>
						</td>
					</tr>
					<tr>
						<td colspan="4">
							<fieldset>
								...
								<label>First: </label><input type="text" name="m_first" id="m_first" title="Enter first name of noncustodial parent's mother."
									value="${ncpRelNameMap.containsKey('2')?  ncpRelNameMap['2'].getFirstNm():''}" size="30" maxlength="15"> <label>Middle:
								</label><input type="text" name="m_middle" id="m_middle" title="Enter middle name of noncustodial parent's mother."
									value="${ncpRelNameMap.containsKey('2')?  ncpRelNameMap['2'].getMiddleNm():''}"	size="30" maxlength="15"> <label>Last:
									</label><input type="text" name="m_last" id="m_last" title="Enter last name of noncustodial parent's mother." value="${ncpRelNameMap.containsKey('2')?  ncpRelNameMap['2'].getLastNm():''}" size="30" maxlength="17">
							</fieldset>
						</td>
					</tr>
				</table>
			...
			<div>
				<fieldset>
						...
						<table>
							<tr>
								<td><label>Street: </label><input type="text"
									name="ma_street" id="ma_street" title="Enter the street address where noncustodial parent receives mail." value="${mailAddr == null ? '' : mailAddr.getAddrLn1()}" size="40" maxlength="40"></td>
								<td><label>City: </label><input type="text"	name="ma_city" title="Enter city where noncustodial parent receives mail." value="${mailAddr == null ? '' : mailAddr.getAddrCty()}" size="25" maxlength="25"></td>
							</tr>
							<tr>
					...
					<p>
						<input type="checkbox" name="res_addr"  id= "res_addr" value="res_addr"  title="Check the box if your residential address is the same as your mail address." ${resAddr == null  ? 'checked' : ''} onclick="checkResidAddr(this)"> Check if residential address is same as mailing address
					</p>
						...
						<fieldset>
							...
							<table>
								<tr>
									<td align="left">
										<label>Street: </label>
										<input type="text" name="res_street" id = "res_street" value="${resAddr == null ? '' : resAddr.getAddrLn1()}" title="Enter the street address for the residential address." size="50" maxlength="50">
									</td>
									<td align="left">
										<label>City: </label>
									...
									<table>
										<tr>
											<td><label>Street: </label>
												<input type="text" name="other_street" id= "other_street" value="${otherAddr == null ? '' : otherAddr.getAddrLn1()}" size="50" maxlength="40">
											</td>
											<td><label>City: </label>
							...
							<td colspan="4">
								<fieldset>
									...
									<label>First: </label><input type="text" name="first_m"
										value="${ncpRelNameMap.containsKey('3')?  ncpRelNameMap['3'].getFirstNm():''}" size="22" maxlength="15"> <label>Middle:	</label><input type="text" name="middle_m"
										value="${ncpRelNameMap.containsKey('3')?  ncpRelNameMap['3'].getMiddleNm():''}"	size="20" maxlength="15"> <label>Last: </label><input type="text" name="last_m"
											value="${ncpRelNameMap.containsKey('3')?  ncpRelNameMap['3'].getLastNm():''}" size="22" maxlength="17">
								</fieldset>
							</td>
						</tr>
					</table>
							...
							<td colspan="4">
								<fieldset>
									...
									<label>First: </label><input type="text" name="d_first"
										value="${ncpRelNameMap.containsKey('3')?  ncpRelNameMap['3'].getFirstNm():''}" size="22" maxlength="15"> <label>Middle:	</label><input type="text" name="d_middle"
										value="${ncpRelNameMap.containsKey('3')?  ncpRelNameMap['3'].getMiddleNm():''}"	size="20" maxlength="15"> <label>Last: </label><input type="text" name="d_last"
											value="${ncpRelNameMap.containsKey('3')?  ncpRelNameMap['3'].getLastNm():''}" size="22" maxlength="17">
								</fieldset>
							</td>
						</tr>
							...
							<td colspan="4">
								<fieldset>
									...
									<label>First: </label><input type="text" name="s_first"
										value="${ncpRelNameMap.containsKey('3')?  ncpRelNameMap['3'].getFirstNm():''}" size="22" maxlength="15"> <label>Middle:	</label><input type="text" name="s_middle"
										value="${ncpRelNameMap.containsKey('3')?  ncpRelNameMap['3'].getMiddleNm():''}"	size="20" maxlength="15"> <label>Last: </label><input type="text" name="s_last"
											value="${ncpRelNameMap.containsKey('3')?  ncpRelNameMap['3'].getLastNm():''}" size="22" maxlength="17">
								</fieldset>
								</td>
						</tr>
					...
					<fieldset>
						...
						<table>
							...
							<tr>
								<td colspan="5" align="left">
									<label>Street: </label>
									<input type="text" name="emp_street" id= "emp_street" value="${empInfo.getThirdPartyInfo().getAddressLn1()}" size="40" maxlength="40">
								</td>
							</tr>
							<tr>
								<td>	
									<label>City:</label>
									<input type="text" name="emp_city" id="emp_city"  value="${empInfo.getThirdPartyInfo().getThirdPartyCity()}" size="25" maxlength="25">
								</td>
								<td>&nbsp;</td>
								<td align="left"><label>State: </label>
			...
			<div>
						...
						<option value="${cnty.getCodeId()}"
							${ncpOrderMap['1'].getCounty().equals(cnty.getCodeId()) ? 'selected' : ''}>${cnty.getCodeDesc()}</option>
								...
								<tr>
									...
									<td><input type="text" name="court_payor" title="Enter first and last name of person ordered to pay child support." value="${ncpOrderMap.containsKey('1')?  ncpOrderMap['1'].getPayorNm():''}"
										size="20" maxlength="40"></td>
									<td>&nbsp;</td>
									<td><label>Recipient: </label></td>
									<td><input type="text" name="court_recip" title ="Enter first and last name of person receiving child support."  value="${ncpOrderMap.containsKey('1')?  ncpOrderMap['1'].getRecipientNm():''}"
										size="20" maxlength="40"></td>
								</tr>
								<tr>
									<td colspan="5">&nbsp;</td>
					...
					<c:forEach var="cnty" items="${countyLookup}">
						<option value="${cnty.getCodeId()}"
							${ncpOrderMap['2'].getCounty().equals(cnty.getCodeId()) ? 'selected' : ''}>${cnty.getCodeDesc()}</option>
								...
								<tr>
									<td><label>Payor: </label></td>
									<td><input type="text" name="medical_payor" title="Enter first and last name of person ordered to pay child support." value="${ncpOrderMap.containsKey('2')?  ncpOrderMap['2'].getPayorNm():''}"
										size="20" maxlength="40"></td>
									<td>&nbsp;</td>
									<td><label>Recipient: </label></td>
									<td><input type="text" name="medical_recip"  title ="Enter first and last name of person receiving child support." value="${ncpOrderMap.containsKey('2')?  ncpOrderMap['2'].getRecipientNm():''}"
										size="20" maxlength="40"></td>
								</tr>
								<tr>
									<td colspan="5">&nbsp;</td>
					...
					<c:forEach var="cnty" items="${countyLookup}">
						<option value="${cnty.getCodeId()}"
							${ncpOrderMap['3'].getCounty().equals(cnty.getCodeId()) ? 'selected' : ''}>${cnty.getCodeDesc()}</option>
								...
								<tr>
									<td><label>Payor: </label></td>
									<td><input type="text" name="spousal_payor" title="Enter first and last name of person ordered to pay child support." value="${ncpOrderMap.containsKey('3')?  ncpOrderMap['3'].getPayorNm():''}"
										size="20" maxlength="40"></td>
									<td>&nbsp;</td>
									<td><label>Recipient: </label></td>
									<td><input type="text" name="spousal_recip" title ="Enter first and last name of person receiving child support." value="${ncpOrderMap.containsKey('3')?  ncpOrderMap['3'].getRecipientNm():''}"
										size="20" maxlength="40"></td>
								</tr>
								<tr>
									<td colspan="5">&nbsp;</td>
					...
					<c:forEach var="cnty" items="${countyLookup}">
						<option value="${cnty.getCodeId()}"
							${ncpOrderMap['4'].getCounty().equals(cnty.getCodeId()) ? 'selected' : ''}>${cnty.getCodeDesc()}</option>
								...
								<tr>
									<td><label>Payor: </label></td>
									<td><input type="text" name="voluntary_payor" title="Enter first and last name of person ordered to pay child support." value="${ncpOrderMap.containsKey('4')?  ncpOrderMap['4'].getPayorNm():''}"
										size="20" maxlength="40"></td>
									<td>&nbsp;</td>
									<td><label>Recipient: </label></td>
									<td><input type="text" name="voluntary_recip" title ="Enter first and last name of person receiving child support." value="${ncpOrderMap.containsKey('4')?  ncpOrderMap['4'].getRecipientNm():''}"
										size="20" maxlength="40"></td>
								</tr>
								<tr>
									<td colspan="5">&nbsp;</td>
				...
				<div>
					...
					<dl class="feature">
						...
						<dd>
							<input title="You must select at least one option." 
							type="radio" name="protOrd" value="3"
