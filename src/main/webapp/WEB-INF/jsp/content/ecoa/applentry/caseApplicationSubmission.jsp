...
<script>
	...
	function validateform(selButton) {
		...
		else if (selButton.id==="sbmtbtn"){
			if(!confirm("No changes or updates can be made on the application after it is submitted."))
...
<form name="OnlineAppSbmtForm" id="OnlineAppSbmtForm" method="post"	action="${pageContext.request.contextPath}/cssp/user/caseApplicationSubmission.htm" modelAttribute="appBean">
	...
	<div id="aplContent">
		<div class="gutter2">
				...
				<h3>SECTION 6: Certification Statement <b><span  style="float:right;"><font size="2">Reference Number:${selectedApp}</font></span></b></h3>
				<hr />
