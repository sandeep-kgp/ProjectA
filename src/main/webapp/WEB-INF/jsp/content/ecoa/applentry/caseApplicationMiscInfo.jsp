...
<input type="hidden" name="applSbmt" value="${appBean.isApplSbmtd()}">
	...
	<div id="aplContent">
		<div class="gutter2">
				...
				<h3>SECTION 5: APPLICATION ADDITIONAL INFORMATION <b><span  style="float:right;"><font size="2">Reference Number:${selectedApp}</font></span></b></h3>
				<hr />					
			...
			<div>
				<p>
					...
					<select onchange="toggleTextBox(this)" title="Enter additional information or comments regarding this application.">
