...
<div id="content">
	<div class="gutter">
		<div bgcolor="#FFFFFF" text="#000000" onbeforeprint="hidePrint();"
			onafterprint="showPrint();" link="#000000" vlink="#000000"
			alink="#000000">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td><b><a NAME="Top"></a>North Carolina Child Support
							Guidelines<br> </b><b><br> Effective January 1, 2015</b>

						<ul align="left">
							<li><a href="#Commentary">Introduction</a></li>
							<br>
							<li><a href="#NCCSGuidelines">Applicability and Deviation</a></li>
							<br>
							<li><a href="#RetChildSupport">Retroactive Child Support</a></li>
							<br>
							<li><a href="#SSReserve">Self-Support Reserve; Supporting Parents With Low Incomes</a></li>
							<br>
							<li><a href="#DeterminationofSupport">Determination of Support in Cases involving High Combined Income</a></li>
							<br>
							<li><a href="#AssumptionsandExpenses">Assumptions and Expense Included In Schedule of Basic Child Support Obligations</a></li>
							<br>
							<li><a href="#Income">Income</a></li>
							<br>
							<li><a href="#Existing">Existing Support Obligations and Responsibility For Other Child(ren)</a></li>
							<br>
							<li><a href="#Basic">Basic Child Support Obligation</a></li>
							<br>
							<li><a href="#ChildCare">Child Care Costs</a></li>
							<br>
							<li><a href="#Health">Health Insurance and Health Care Costs</a></li>
							<br>
							<li><a href="#Extraordinary">Other Extraordinary Expenses</a></li>
							<br>
							<li><a href="#DeterminationCSO">Child Support Worksheets</a></li>
							<br>
							<li><a href="#Modification">Modification</a></li>
							<br>
							<li><a href="${pageContext.request.contextPath}/getGuideLinesTable.htm">Proposed Monthly Basic Child Support Obligations</a></li>

						</ul> <i><a Name="Commentary"></a></i><b><font color="#3300FF">
							 Introduction</font></b>
						<p>
						<p align="right">
							<font color="#red"><a href="#Top">Top</font></a>
						</p> 
						<p align="left">
							...
							orders.<br> <br> These revised guidelines are the
							product of the ongoing review process conducted by the Conference
							of Chief District Judges. The Conference conducted a public
							hearing to provide interested citizens an opportunity to comment
							on the guidelines and also considered written comments from
							agencies, attorneys, judges and members of the public. <br>
						</p> <b> <a NAME="NCCSGuidelines"></a> <font 
							color="#3300FF">Applicability and Deviation</font></b>
						<p>
						<p align="right">
							<a href="#Top">Top</a>
						</p>
						...
						<p align="left">These revised guidelines are effective January
							1, 2015, and apply to child support actions heard on or after
							that date.</p>
						<p align="left">
							...
							agreement is unreasonable. <br> <br> The guidelines
							must be used when the court enters a temporary or permanent child
							support order in a non-contested case or a contested hearing. <br>
							<br> The court upon its own motion or upon motion of a party
							...
							support obligation and 100% of the insurance premium.) <br>
							<br> The guidelines are intended to provide adequate awards
							of child support that are equitable to the child and both of the
							child's parents. When the court does not deviate from the
							guidelines, an order for child support in an amount determined
							...
							obligation under the guidelines. </font><br>
						</p>
						<p align="left">
							<i><a NAME="RetChildSupport"></a></i><font color="#3300FF"
								><b>Retroactive Child Support</b></font>
						</p>
						<p>
						<p align="right">
							<font color="#0000FF"><a href="#Top">Top</a></font>
						</p>

						<p align="left">
							 In a
								direct response to Respess v. Respess, N.C. App. , 754 S.E.2d
								...
								support obligations [. . .]? <br> <br> In cases
								involving a parent's obligation to support his or her child for
								a period before a child support action was filed (i.e., cases
						...
						<p align="left">
							<i><a NAME="SSReserve"></a></i><font color="#3300FF"><b>Self-Support
									Reserve; Supporting Parents With Low Incomes</b></font>
						</p>
						<p>
						<p align="right">
							<font color="#0000FF"><a href="#Top">Top</a></font>
						...
						<p align="left">
							The
								...
								of living based on the 2014 federal poverty level for one person
								($973 per month). For obligors with an adjusted gross income of
								less than $1097.00, the Guidelines require, absent a deviation,
								the establishment of a minimum support order ($50). For obligors
								with adjusted gross incomes above $1097.00, the Schedule of
								Basic Support Obligations incorporates a further adjustment to
								maintain the self-support reserve for the obligor. </font>
						</p>
						<p align="left">
						...
						<p align="left">
							<i><a NAME="DeterminationofSupport"></a></i><font color="#3300FF"><b>Determination
									Of Support In Cases Involving High Combined Income</b></font>
						</p>
						<p>
						<p align="right">
							<font color="#0000FF"><a href="#Top">Top</font></a>
						</p>

						<p align="left">In cases in which the parents' combined
							...
							cannot be determined by using the child support schedule.</p>
						<p align="left">
							In cases in which the parents' combined income is above $25,000
							...
							minimal level of child support. <br>
						</p>
						<p align="left">
							<i><a NAME="AssumptionsandExpenses"></a></i><font color="#3300FF">
								<b>Assumptions And Expenses Included In Schedule Of Basic
									Child Support Obligations</b>
							</font>
						<p>
						<p align="right">
							<font color="#0000FF"><a href="#Top">Top</font></a>
						...
						<p align="left">
							North Carolina's child support guidelines are based on the
							...
							economic research regarding family expenditures for children.<br>
							<br> The child support schedule that is a part of the
							...
							schedule.<br> <br> The schedule assumes that the parent
							who receives child support claims the tax exemptions for the
							child.
						<p align="left">
							<i><a NAME="Income"></a></i><font color="#3300FF"><b>Income</b></font>
						<p>
						<p align="right">
							<font color="#0000FF"><a href="#Top">Top</font></a>
						</p>
						...
						<p align="left">
							The Schedule of Basic Child Support Obligations is based upon net
							...
							from income.<br> <br> <b>(1) Gross Income.</b>
							...
							support.<br> <br> Specifically excluded from income are
							...
							parent's wages, salary or pay.<br> <br> Veterans
							Administration benefits and Social security benefits received for
							the benefit of a child as a result of the disability or
							...
							are deductible from that parent's child support obligation. If
							the Social Security or Veterans Administration benefits received
							by the child are based on the disability or retirement of the
							obligor and exceed the obligor?s child support obligation, no
							order for prospective child support should be entered, unless the
							court decides to deviate.<br> <br> Except as otherwise
							provided, income does not include the income of a person who is
							not a parent of a child for whom support is being determined
							regardless of whether that person is married to or lives with the
							child's parent or has physical custody of the child.<br> <br>
							<b>(2) Income from self-employment or operation of a
								business.</b> Gross income from self-employment, rent, royalties,
							...
							purposes.<br> <br> Expense reimbursements or in-kind
							...
							living expenses.<br> <br> <b>(3) Potential or
								Imputed Income.</b> If the court finds that the parent's voluntary
							unemployment or underemployment is the result of the parent's bad
							faith or deliberate suppression of income to avoid or minimize
							his or her child support obligation, child support may be
							calculated based on the parent's potential, rather than actual,
							income. Potential income may not be imputed to a parent who is
							physically or mentally incapacitated or is the primary custodian
							for a child who is under the age of three years and for whom
							child support is being determined.<br> <br> The amount
							of potential income imputed to a parent must be based on the
							parent's employment potential and probable earnings level based
							...
							community. If the parent has no recent work history or vocational
							training, potential income should not be less than the minimum
							hourly wage for a 40-hour work week.<br> <br> <b>(4)
								Income Verification.</b> Child support calculations under the
						...
						<p>
							<i><a NAME="Existing"></a></i><font color="#3300FF"><b>Existing
									Support Obligations And Responsibility For Other Children</b></font>
						</p>
						<p>
						<p align="right">
							<font color="#0000FF"><a href="#Top">Top</font></a>
						...
						<p>
							Current child support payments actually made by a parent under
							...
							reasonable and extended period of time. <b>The fact that a
								...
								deviation from the child support guidelines.</b> When establishing,
							...
							involving the same non-custodial parent.<br> <br> Any
							...
							the final presumptive child support obligation.<br> <br>
							...
							basis for modifying an existing order.<br> <br> A
							...
							for these children based on the parent's income.<i></i><br>
							<br>

						</p>
						<p>
							<i><font color="#0000FF"><a Name="Basic"></a></font></i><font
								color="#0000FF"><font  color="#3300FF"><b>Basic
										Child Support Obligation</b></font></font>
						</p>
						<p>
							<font face="Arial, Helvetica, sans-serif">
								<p align="right">
									<font color="#0000FF"><a href="#Top"><font size="2">Top</font></a></font>
								</p>
							</font>
						<p>
						...
						<p>
							Reasonable child care costs that are, or will be, paid by a
							...
							as a basis for deviation. <br> <br> <br> <br>
							<i><a NAME="Health"></a></i><font color="#3300FF"><b>Health
									Insurance and Health Care Costs</b></font>
						</p>
						<p>
						<p align="right">
							<font color="#0000FF" size="2"><a href="#Top">Top</a></font>
						</p>

						<p>
							The amount that is, or will be, paid by a parent (or a parent's
							spouse) for health (medical, or medical and dental) insurance for
							...
							whom support is being determined.<br> <br> In any case,
							including those where the parent's income falls within the shaded
							area of the child support schedule, the court may order that
							uninsured medical or dental expenses in excess of $250 per year
							or other uninsured health care costs (including reasonable and
							necessary costs related to orthodontia, dental care, asthma
							treatments, physical therapy, treatment of chronic health
							problems, and counseling or psychiatric therapy for diagnosed
							mental disorders) be paid by either parent or both parents in
							such proportion as the court deems appropriate.<br> <br>
							The court must order either parent to obtain and maintain health
							insurance coverage for a child if it is actually and currently
							available to the parent at a reasonable cost. If health insurance
							...
							insurance. At the time of the adoption of these Child Support
							Guidelines, G.S. 50-13.11(a1) specifies that health insurance is
							considered reasonable in cost if it is employment related or
							other group health insurance, regardless of the service delivery
							mechanism.
						</p>
						<p>
							<i><a NAME="Extraordinary"></a></i><font color="#3300FF"><font
								color="#3300FF"><b>Other Extraordinary Expenses</b></font></font>
						</p>
						<p>
						<p align="right">
						...
						<p>Other extraordinary child-related expenses (including (1)
							...
							in the child's best interest.</p>
						<p>
							<i><a NAME=DeterminationCSO></a></i><font color="#3300FF"><b>Child Support Worksheets</b></font>
						</p>
						<p>
						<p align="right">
							<font color="#0000FF"><a href="#Top">Top</font></a>
						...
						<p>
							...
							support worksheets.<br> <br> The child support
							...
							whom support is being determined on the worksheets.<br> <br>
							...
							physical custody of the child.<br> <br> Use Worksheet B
							...
							area of the schedule when using Worksheet B.<br> <br>
							...
							support obligation. <br> <br> Use Worksheet C when
						...
						<p>
							<i><font color="#0000FF"><a NAME="Modification"></a></font></i><font
								color="#3300FF"><b>Modification</b></font>
						</p>
						<p>
						<p align="right">
							<font color="#0000FF"><a href="#Top">Top</font></a>
						...
						<p>
							...
							the existing child support order.<br>

						</p>
						<p align="right">
							<font color="#3300FF"><a href="#Top">Top</font></a>
						</p></td>
				</tr>
				<tr>
					<td width="29%" height="21">AOC-A-162, Rev. 1/15</td>
				</tr>
				<tr>
					<td width="29%" height="19">&copy; 2015 Administrative Office
						of the Courts</td>
				</tr>
			</table>
			<br>
