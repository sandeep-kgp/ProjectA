	...
	<div class="gutter">
		...
		<div class="centered">
		   ...
		   <dl class="feature">
				<form name ="preNcIdUserLogin" id= "preNcIdUserLogin" action="<c:url value='/j_spring_security_check'/>" method="post">
					<table>
							<tr>
								...
								<td><input type="text" name="j_username" maxlength="10"	id="j_username" value="" title="Enter your login Name." /></td>
							</tr>
							<tr>
								<td><label for="password" class="required">Old Password:</label></td>
								<td><input type="password" name="j_password" maxlength="10"	id="j_password" value="" title="Enter your password." /></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
			...
			<br>			
				<!-- <p style="color:red"> -->
				<p><strong>Note: You are allowed to use your old username and password to login temporarily. They will expire in 6 months or in 10 logins whichever comes first.</strong> </p>
				<!-- <p>Please set up your NCID at: <a target="_blank" href=https://ncid.nc.gov /> NCID </a> before your old credentials expire. </p> -->
				<p>Please set up your NCID before your old username and password expire. </p>				
			<br>			 		  
		</div>		
		<hr>	
	</div>
