				...
				<div id = "workSheetCCalc" style="margin-left: 15px" style="margin-right:5px">
					<table width="99%" border="1" cellpadding="0" cellspacing="0">
						<tr>
							...
							<td colspan="2" height="35" style="vertical-align: top">
								<p>
							...
							<td width="11%" height="35" style="vertical-align: top">
								<p>
						...
						<tr>
							...
							<td width="11%" height="32" style="vertical-align: top">
								<p>
